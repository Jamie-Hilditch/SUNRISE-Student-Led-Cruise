...
def transect_coordinates(lon: NDArray[np.float64],lat: NDArray[np.float64]) -> tuple[NDArray[np.float64],NDArray[np.float64]]:
...
def transect_velocities(u: NDArray[np.float64],v: NDArray[np.float64]) -> tuple[NDArray[np.float64],NDArray[np.float64]]:
